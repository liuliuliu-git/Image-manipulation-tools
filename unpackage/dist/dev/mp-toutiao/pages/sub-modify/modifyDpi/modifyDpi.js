      ...
      uni.chooseImage({
        ...
        success: function () {
          var _success = (0, _asyncToGenerator2.default)( /*#__PURE__*/_regenerator.default.mark(function _callee(res) {
            var img, _loop, i, interval, promises;
                      ...
                      return _regenerator.default.wrap(function _loop$(_context) {
                        while (1) {
                          switch (_context.prev = _context.next) {
                            case 0:
                              _context.next = 2;
                              return (0, _tools.verifyImage)(_this.$store.state.ttAppid, res.tempFilePaths[i], _this.$store.state.clientType).then(function (res) {
                                if (!res) {
                                  return;
                                } else {
                                  _this.imageUrls.splice(i, 1);
                                  uni.showToast({
                                    title: '图片存在风险,请重新上传',
                                    duration: 2000,
                                    icon: "fail"
...
//# sourceMappingURL=../../../../.sourcemap/mp-toutiao/pages/sub-modify/modifyDpi/modifyDpi.js.map